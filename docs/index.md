...
- [User guide](user-guide.md) — install, profiles, terminals, updates, and recovery.
- [Troubleshooting](troubleshooting.md) — diagnose startup, plugins, networking, and workspace errors.
...
Profile, the first error line, and an exported redacted diagnostic bundle. Never
