...
const en = {
  ...
  'remote.scanHint':
    'Scanning once pairs that device. The link carries this session’s secret, so send it to nobody.',
  ...
  'remote.note.secret':
    'The secret is made when the door opens and is never written to disk. Closing it throws the secret away.',
...
const zh: Record<MessageKey, string> = {
  ...
  'remote.scan': '扫码配对',
  'remote.scanHint': '扫描一次即可完成配对。链接中带有本次会话的密钥，请勿转发给任何人。',
  'remote.address': '地址',
  ...
  'remote.note.secret': '密钥在开门时生成，不会写入磁盘；关闭访问即丢弃该密钥。',
