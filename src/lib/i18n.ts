...
const en = {
  ...
  'harness.versions': 'Published Harness versions',
  'harness.versions.loading': 'Loading…',
  'harness.versions.hint':
    'Switching stops Harness. The selected release is installed and startup-tested separately; a failed check keeps the previous runtime. Studio marks the bundled tested release.',
  'harness.versions.choose': 'Choose a version…',
  'harness.versions.install': 'Install and verify',
  'harness.versions.qualified': 'Qualified for this Studio release',
  'harness.versions.unqualified': 'Published upstream release; not qualified for this Studio build',
  ...
  'log.copyVisible': 'Copy displayed logs',
  'log.visibleLines': '{count} of {total} lines',
  ...
  'plugins.tab.installable': 'Not installed',
  ...
  'plugins.checkVersion': 'Check available version',
  'plugins.currentVersion': 'Currently installed',
  'plugins.currentVersionReady': 'This version is installed',
  'plugins.review.replace': 'Review version change',
...
const zh: Record<MessageKey, string> = {
  ...
  'harness.versions': '已发布的 Harness 版本',
  'harness.versions.loading': '加载中…',
  'harness.versions.hint':
    '切换会停止 Harness。所选版本将独立安装并验证启动，检查失败保留原运行时。Studio 标记随应用验证的版本。',
  'harness.versions.choose': '选择版本…',
  'harness.versions.install': '安装并验证',
  'harness.versions.qualified': '已通过当前 Studio 版本验证',
  'harness.versions.unqualified': '上游已发布，但未通过当前 Studio 构建验证',
  ...
  'log.issues': '警告与错误',
  'log.search': '搜索日志',
  'log.copyVisible': '复制当前显示的日志',
  'log.visibleLines': '显示 {count} / {total} 行',
  ...
  'plugins.checkVersion': '查看可用版本',
  'plugins.currentVersion': '当前安装版本',
  'plugins.currentVersionReady': '已安装此版本',
  'plugins.review.replace': '检查版本变更',
